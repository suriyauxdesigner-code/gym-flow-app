  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl p-0 flex flex-col max-h-[90vh]">
        <DialogTitle className="sr-only">Create Class</DialogTitle>

        {/* Sticky Header */}
        <div className="px-6 py-5 border-b border-slate-200 dark:border-slate-800 shrink-0 pr-14">
          <h2 className="text-lg font-semibold text-slate-900 dark:text-slate-100">Create Class</h2>
          <p className="mt-0.5 text-sm text-slate-500 dark:text-slate-400">Schedule a new class session</p>
        </div>
        ...
        <div className="overflow-y-auto flex-1 px-6 py-5 space-y-6">
          ...
          <Card className="rounded-2xl shadow-sm">
            ...
            <CardContent className="space-y-4">
              <div className="space-y-1.5">
                <Label className="text-xs font-medium text-slate-600 dark:text-slate-400">Max Capacity</Label>
                <Input
                  type="number"
                  min="1"
                  value={form.capacity}
        ...
        <div className="flex items-center justify-end gap-2 px-6 py-4 border-t border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 shrink-0">
          ...
          <Button onClick={handlePublish} className="bg-indigo-600 text-white hover:bg-indigo-700">
            Publish Class
          </Button>
        </div>
      </DialogContent>
